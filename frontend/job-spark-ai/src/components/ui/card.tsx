  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        interactive: "bg-card shadow-md hover:-translate-y-1 hover:shadow-xl cursor-pointer",
        gradient: "bg-gradient-to-br from-card to-secondary/50 shadow-lg",
        outlined: "bg-transparent border-2 border-border/50",
        feature: "bg-card shadow-lg border-primary/10 hover:border-primary/30 hover:shadow-xl",
      },
    },
    defaultVariants: {
      variant: "default",
